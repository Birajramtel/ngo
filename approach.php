...
<body>
    ...
    <section>
        <div class="container">
            <h1 class="d-flex justify-content-center who_we_are mb-3"><strong>OUR APPROACH</strong></h1>
            <div class="row">
                <div class="col-md-12">
                    <p class="text_aligining">BBP Pariwar strengthens the capacity of the people of backwarded and marginalized
                        communities and the farmers to create a convenient working environment and to empower
                        them with different capacity building trainings and activities for the upliftment of
                        their economic as well as intellectual status to help them become self-reliant and
                        also focuses on the reproductive health, women's issues, education, community based
                        natural resources management, sustainable community development activities etc.
                        <br> We work with small holder farmers Janajati, Tribal communities and the socially excluded
                        ...
                        improves the community participation in existing economic, social, educational, health and
